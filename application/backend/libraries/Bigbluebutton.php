...
define("CONFIG_SECURITY_SALT", "08e96a7bc05ee01dfd03ebfe16addb41");
define("CONFIG_SERVER_BASE_URL", "http://school.netders.com/bigbluebutton/");
	...
	*/
	...
	public function getCreateMeetingUrl($creationParams) {
		...
		*/
		...
		'&autoStartRecording='.urlencode($creationParams['autoStartRecording']).
	...
	*/
	...
	public function getRecordingsUrl($recordingParams) {
		...
		*/
		...
		return ($recordingsUrl.'&checksum='.sha1("getRecordings".$this->_securitySalt));
