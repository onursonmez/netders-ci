...
class Bigbluebutton {
    ...
    function Bigbluebutton()
	{
        ...
        $this->api_url          = 'https://school.netders.com/bigbluebutton/api/';
        $this->security_salt    = "fd8e601eb1f427ac4edf4b85a0970008";
	}
	...
	public function create_meeting($meetingID, $name, $duration=60, $moderatorPW=NULL, $attendeePW=NULL, $maxParticipants = 2, $logoutURL=NULL, $welcome=NULL)
	{
		global $CFG;
