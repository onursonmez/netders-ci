<div class="panel panel-default margin-bottom-20">
	<div class="panel-heading"><h4>Tanıtım Yazıları</h4></div>
		...
		<form  action="<?=site_url('users/informations')?>" method="post" class="ajax-form js-dont-reset">
			<div class="row">	
				...
				<div class="form-group col-md-12">
					...
					<span class="lightgrey-text font-size-11" id="text_title_count">45 karakter kaldı</span>
				</div>
				...
				<div class="form-group col-md-12">
					...
					<span class="lightgrey-text font-size-11" id="text_long_count">1000 karakter kaldı</span>
				</div>
				...
				<div class="form-group col-md-12">
					...
					<span class="lightgrey-text font-size-11" id="text_reference_count">1000 karakter kaldı</span>
				</div>						
