	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-9">
				...
				<p>Verdiğiniz siparişler, güvenliğiniz için, ödeme istemcisi tarafından 150 hile kontrol mekanizmasından geçip onaylanmaktadır. Bu kontrol mekanizmasına takılan siparişler başarı ile sonuçlanamamaktadır.</p>
				...
				<a href="<?=site_url('memberships/cart')?>" class="btn btn-orange">Alışveriş sepetine dönüp tekrar deneyin</a>
			</div>
		</div>
	</div>
</section>