...
<div class="container" style="margin-top:30px">
	<div class="profile-well">
		<div class="profile-well-body text-center" style="padding-top:30px;">
			Üzgünüz, bu hesap kullanılmamaktadır.			
		</div>
	</div>
</div>
<?else:?>
<section class="profile">
	<div class="profile-cover">
		<div class="profile-cover-image" style="background:url(<?=base_url('public/img/cover.jpg')?>); background-attachment: fixed;">
		</div>
	</div>
	<div class="container">
			...
			<div class="row">
				...
				<div class="col-sm-12 col-md-4 col-lg-3 no-float profile-top-right">
					...
					<div class="text-center margin-top-20">
						<a href="#" class="scrollto" data-attr-scroll="newcomplaint" data-scroll-offset="100"><i class="fa fa-warning"></i> Şikayet et</a>
					</div>
										
					<?if($user->price_min || $user->price_max):?>
					<div class="text-center margin-top-10 price">
		...
		<div class="profile-well">
			...
			<div class="profile-well-body">
				...
				<?if($user->school2_name && $user->school2_section):?>
					<div><span class="label label-success pull-left margin-right-5" style="vertical-align:middle;">Lisans</span> <strong><?=$user->school2_name?></strong> - <?=$user->school2_section?> <?if($user->school2_end):?>(<?=$user->school2_end?>)<?endif;?></div>
				<?endif;?>								
					...
					<tbody>
						...
						<tr>
							<td><?if($price->status == 'A'):?>
									<a href="<?=site_url($price->seo_link)?>" target="_blank"><?=$price->subject_title?> - <?=$price->level_title?></a>
								<?else:?>
		...
		<div class="profile-well" id="newcomplaint">
			<h3>Şikayet Et</h3>
			<div class="profile-well-body">
				...
				<form method="POST" action="<?=site_url('users/sendcomplaint')?>" class="ajax-form">
					<div class="row">
						...
						<div class="col-md-2 margin-bottom-10">
							<img src="<?=base_url('captcha/'.generate_captcha('ajax_complaint'))?>" width="100%" height="32" />
						</div>
						<div class="col-md-12">
							<button type="submit" class="btn btn-orange js-submit-btn"><i class="fa fa-rocket"></i> Gönder</button>
							<button disabled="disabled" class="btn btn-orange hide js-loader"><i class="fa fa-spinner fa-pulse fa-fw"></i> Lütfen bekleyiniz...</button>
